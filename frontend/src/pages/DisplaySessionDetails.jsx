...
const DisplaySessionDetails = () => {
  ...
  const getDetails = async () => {
    try {
        ...
        const response = await axios.get(`https://recruitment-bot-vercel-backend-i1lljia9z-riyaz-shaiks-projects.vercel.app/api/session/get-session-details?sessionId=${sessionID}`);
